            ...
            <div class="col-lg-4">
                <div class="pr-lg-4">
                    <div class="mb-4">
                        ...
                        <h3 class="text-white">e-Journal</h3>
                    </div>
                    <p class="text-white-50">Tentang kami</p>
                    <p class="text-white-50">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Animi odio cumque, quis error modi nesciunt quia molestias qui sit facilis saepe vitae perferendis quidem voluptas inventore rem ipsam asperiores sed?</p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="float-left pull-none">
                    <p class="text-white-50">2020 © e-Journal. Design by <a href="https://coderthemes.com/" target="_blank" class="text-white-50">Harvasoft</a> </p>
                </div>
